...
(function (VG) {
  ...
  const store = {
    ...
    canAction(roleKey, action, moduleId) {
      ...
      const expanded = expandModuleIdsFromRole(r, roleKey);
      if (expanded === "all") return true;
      const mapped = PERM_MODULE_TO_APP[moduleId] || moduleId;
      return expanded.includes(mapped) || expanded.includes(moduleId);
    },
